...
class Decoder(nn.Module):
    def __init__(self, encoder_channels=(64, 128, 256, 512), decoder_channels=128, n_classes=6, last_feat_size=16):
        super().__init__()
        ...
        self.head = nn.Sequential(ConvBNReLU(decoder_channels, decoder_channels // 2),
                                  ...
                                  nn.Upsample(scale_factor=2, mode='bilinear'),
                                  Conv(decoder_channels // 2, n_classes, kernel_size=1))
...
class EfficientPyramidMamba(nn.Module):
    def __init__(self,
        ...
        self.decoder = Decoder(encoder_channels=encoder_channels, decoder_channels=decoder_channels, n_classes=n_classes, last_feat_size=last_feat_size)
